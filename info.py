...
BOT_TOKEN = environ.get('BOT_TOKEN', "6059691371:AAG0T1-_N82PQapWISEGccxQB7sYWEddDts")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6095755800').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001953592449').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://fuch3:fuch3@cluster0.s8ekziv.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "bharath")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001953592449'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Rivals_anime_group')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [SexretBot™](https://t.me/Rivals_network)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Sexert Bot™](https://t.me/Rivals_network)</b> ↭  🔥")
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1001953592449'))

#ai
AI = is_enabled((environ.get("AI","False")), False)
OPENAI_API = environ.get("OPENAI_API","")
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001953592449")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
# Requested Content template variables ---
ADMIN_USRNM = environ.get('ADMIN_USRNM','trigger_abhi') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','rivals_network') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','it_was_abhi') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','DM4OP')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
CAPTION_BUTTON_URL = "https://t.me/It_was_abhi"
